            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  ...
                  >
                    <div className="p-2 rounded-full bg-zinc-900 border border-zinc-800 group-hover:border-primary/20 group-hover:bg-primary/10 transition-colors duration-300">
                      <item.icon
                        size={16}
